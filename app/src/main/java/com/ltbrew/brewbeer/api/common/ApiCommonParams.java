...
public class ApiCommonParams {
    ...
    //    192.168.2.168
    public static final String IP_DOMAIN = "api.beiqicloud.com";
    public static final String AUTHORIZE_URL = "http://" + IP_DOMAIN + ":8104";
//    public static final String API_URL = "http://" + IP_DOMAIN + ":8100";
    public static final String DOWN_UP_URL = "http://" + IP_DOMAIN + ":8106";
