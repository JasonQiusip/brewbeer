 ...
 */
public class NoticeFromServiceDialog extends Dialog implements View.OnClickListener {

    TextView tv_notice;
    private OnPositiveButtonClickListener onPositiveButtonClickListener;
    private OnNegativeButtonClickListener onNegativeButtonClickListener;

    public NoticeFromServiceDialog(Context context) {
        super(context);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        getWindow().setBackgroundDrawableResource(R.drawable.bg_dialog);
        View phoneNumbSettingDialog = LayoutInflater.from(context).inflate(R.layout.dialog_service_notice, null, false);
    ...
    public NoticeFromServiceDialog setMsg(String txt){
        tv_notice.setText(txt);
        return this;
    }

    public NoticeFromServiceDialog setOnPositiveButtonClickListener(OnPositiveButtonClickListener onPositiveButtonClickListener){
        this.onPositiveButtonClickListener = onPositiveButtonClickListener;
        return this;
    }

    public NoticeFromServiceDialog setOnNegativeButtonClickListener(OnNegativeButtonClickListener onNegativeButtonClickListener){
